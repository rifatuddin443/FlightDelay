...
- 2026-01-31: Added change-log header block for tracking future changes.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--epsilonfixed',dest='epsilonfixed',
        default=False,
        action='store_true',help='Enable epsilon-calibrated DP-SGD (uses Opacus make_private_with_epsilon)'
    )
    # Backward-compatible alias (do not advertise)
...
def main() -> None:
    ...
    stage3_lr = args.stage3_lr if args.stage3_lr is not None else (args.lr * 0.1)  # Default: 10% of global LR
