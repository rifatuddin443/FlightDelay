    ...
    *,
    ...
    for epoch in range(1, epochs + 1):
        ...
        for batch in train_loader:
            ...
            # Privacy budget guard: do not take a step if it would cross epsilon.
            if accountant is not None and privacy_engine is not None:
...
def main() -> None:
    ...
    if train_time_x is not None:
        ...
        train_loader_stage3 = DataLoader(train_ds_stage3, batch_size=args.batch_size, shuffle=True, drop_last=True)
        val_loader_stage3 = DataLoader(val_ds_stage3, batch_size=args.batch_size, shuffle=False, drop_last=False)
    else:
        train_loader_stage3 = DataLoader(train_ds, batch_size=args.batch_size, shuffle=True, drop_last=True)
        val_loader_stage3 = DataLoader(val_ds, batch_size=args.batch_size, shuffle=False, drop_last=False)
