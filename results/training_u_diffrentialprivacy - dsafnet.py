...
parser.add_argument('--use_simple_cnn', default=True, action='store_true', help='use SimpleCNN model')
parser.add_argument('--use_enhanced_cnn', action='store_true', help='use SpatioTemporalCNN model')
...
def main():
    ...
    if args.dp:
        ...
        privacy_engine = None
        csv_filename = 'dsafnettraining_no_dp.csv'
